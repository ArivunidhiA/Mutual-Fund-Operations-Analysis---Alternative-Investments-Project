...
const dbPath = path.join(dataDir, 'mutual_funds.db');
...
createTables()
  ...
  .then(() => {
    console.log('✅ Sample funds data inserted');
    return insertPerformanceData();
  })
  .then(() => {
    console.log('✅ Performance data inserted');
    return insertAlternativeInvestmentsData();
  })
  .then(() => {
    console.log('✅ Alternative investments data inserted');
    return insertComplianceData();
  })
  .then(() => {
    console.log('✅ Compliance data inserted');
